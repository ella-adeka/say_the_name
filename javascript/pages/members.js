...
function members() {
    if (j<membersData.length) {
        ...
        <div class="mainMembers__dets__info">
            ...
            <p class="mainMembers__dets__info__birth_name"><span class="mainMembers__dets__info__label">Name:</span> ${membersData[j].birth_name}</p>
...
function changeOnHover(j) {
    ...
    new hoverEffect({
        ...
        intensity: 0.5,
        image1: 'images/attacca_op3/'+membersData[j].hoverImage,
        image2: 'images/members/'+membersData[j].image,
        displacementImage: 'images/seventeen_logo.png'
    });
